...
const About = () => {
    ...
    return (
        <>
            <div className=" my-4  container d-flex justify-content-center align-items-center flex-column " style={{ fontFamily: "poppins" }}>


            <h1 className='display-3'> About Us </h1>
                
                <div className="about-details my-4 d-flex justify-content-center align-items-center flex-column container ">
